...
import { LoadingOutlined, PlusOutlined, UploadOutlined } from '@ant-design/icons/lib/icons'
...
class UploadView extends Component {
  ...
  handlePreview = async (file: { url: any; preview: unknown; originFileObj: any }) => {
  ...
  handle_Change = ({ fileList }: { fileList: any }) => this.setState({ fileList })
